...
seqOptional (x :. xs) = combineOptional x (seqOptional xs)

combineOptional :: Optional a -> Optional (List a) -> Optional (List a)
combineOptional Empty _ = Empty
combineOptional _ Empty = Empty
combineOptional (Full x) (Full xs) = Full (x :. xs)
